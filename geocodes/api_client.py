...
from geocodes import rest
from geocodes.configuration import Configuration
from geocodes.exceptions import ApiTypeError, ApiValueError, ApiException
from geocodes.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.v1_address_geocode  # this is an instance of the class Endpoint
        api_instance.v1_address_geocode()  # this invokes api_instance.v1_address_geocode.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_address_geocode.callable or self.callable in this class
